const FloodFill = (
  ...
  NewColor: number,
  OriginalColor: number | null = null,
): number[][] => {
...
const StartRowCoordinate: number = 1;
const StartColumnCoordinate: number = 1;
const TargetColorCode: number = 2;

console.log("Original Image Matrix:");
console.table(SampleGrid);

const OutputGrid: number[][] = FloodFill(
  SampleGrid,
  StartRowCoordinate,
  StartColumnCoordinate,
  TargetColorCode,
);
